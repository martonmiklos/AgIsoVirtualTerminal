...
public:
	...
	static Justification convert_justification(isobus::Number::HorizontalJustification horizontalJustification,
											   isobus::Number::VerticalJustification verticalJustification);
	static void convert_font_attribute(isobus::FontAttributes &font_attribute, Font *destination_font);
