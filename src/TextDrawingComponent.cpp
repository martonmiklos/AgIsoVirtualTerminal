...
void TextDrawingComponent::paintText(Graphics &g, const std::string &text, bool enabled)
{
	...
	auto sourceString = static_cast<isobus::TextualVTObject*>(sourceObject);

	if (!sourceString->get_option(isobus::TextualVTObject::Options::Transparent))
	{
	...
	else
	{
		switch (fontType)
		{
			case isobus::FontAttributes::FontType::ISO8859_1:
				{
					...
					convert_string_to_utf_8(SourceEncoding::ISO8859_1, value, utf8String, sourceString->get_option(isobus::TextualVTObject::Options::AutoWrap));
			...
			case isobus::FontAttributes::FontType::ISO8859_15:
				{
					std::string utf8String;
					convert_string_to_utf_8(SourceEncoding::ISO8859_15, value, utf8String, sourceString->get_option(isobus::TextualVTObject::Options::AutoWrap));
					decodedValue = utf8String;
				}
				break;
			...
			case isobus::FontAttributes::FontType::ISO8859_2:
				{
					std::string utf8String;
					convert_string_to_utf_8(SourceEncoding::ISO8859_2, value, utf8String, sourceString->get_option(isobus::TextualVTObject::Options::AutoWrap));
					decodedValue = utf8String;
				}
				break;
			...
			case isobus::FontAttributes::FontType::ISO8859_4:
				{
					std::string utf8String;
					convert_string_to_utf_8(SourceEncoding::ISO8859_4, value, utf8String, sourceString->get_option(isobus::TextualVTObject::Options::AutoWrap));
					decodedValue = utf8String;
				}
				break;
			...
			case isobus::FontAttributes::FontType::ISO8859_5:
				{
					std::string utf8String;
					convert_string_to_utf_8(SourceEncoding::ISO8859_5, value, utf8String, sourceString->get_option(isobus::TextualVTObject::Options::AutoWrap));
					decodedValue = utf8String;
				}
				break;
			...
			case isobus::FontAttributes::FontType::ISO8859_7:
				{
					std::string utf8String;
					convert_string_to_utf_8(SourceEncoding::ISO8859_7, value, utf8String, sourceString->get_option(isobus::TextualVTObject::Options::AutoWrap));
					decodedValue = utf8String;
				}
				break;
		}
	...
	if (sourceString->get_option(isobus::TextualVTObject::Options::AutoWrap)) // TODO need to figure out proper font clipping
	{
		g.drawFittedText(decodedValue, 0, 0, sourceString->get_width(), sourceString->get_height(),
						 convert_justification(sourceString->get_horizontal_justification(), sourceString->get_vertical_justification()),
						 static_cast<int>(std::floor((static_cast<float>(sourceString->get_height()) + 0.1f) / fontHeight)), 0.8f);
	}
	else
	{
		g.drawFittedText(decodedValue, 0, 0, sourceString->get_width(), sourceString->get_height(),
